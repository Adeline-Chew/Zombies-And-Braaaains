...
public class Farmer extends Human {
    ...
    private Behaviour[] behaviours = {new HarvestBehaviour(), new FertiliseBehaviour(), new SowBehaviour(), new WanderBehaviour()};
    ...
    /**
     * Firstly check if the Farmer stands on a ripen crop. If not, check if the Farmer stands on an unripe crop.
